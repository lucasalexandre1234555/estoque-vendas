...
def defvender():
    global produtos,estoque, janela
    ...
    def salvarvenda(nome, quantidade):
        global quantidadeentry,vender,estoque,preco,qtde,mese
        
        for i in meses:
            with open(rf'C:\Users\User\Desktop\lucas python\LUCAS PYTHON\estoque de {i}.txt', 'a') as f:
                estoque=(str(f.read()).strip()) 
                print(estoque)
